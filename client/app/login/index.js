...
const Login = () => {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            const authApiUrl = 'https://ezhire.onrender.com/auth/login'; // Replace with your actual API endpoint
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.lightWhite }}>
                ...
                <View style={{ flex: 1, marginHorizontal: 22 }}>
                    ...
                    <View style={{ marginBottom: 12 }}>
                        ...
                        {emailError && (
                            <Text style={{ color: COLORS.error, fontFamily: FONT.medium }}>{emailError}</Text>
                        )}
                    </View>
                    ...
                    <View style={{ marginBottom: 12 }}>
                        ...
                        {passwordError && (
                            <Text style={{ color: COLORS.error, fontFamily: FONT.medium }}>{passwordError}</Text>
                        )}
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 20 }}>
                        ...
                        />
                        <Text style={{ fontSize: 14, fontFamily: FONT.medium }}>Or Login with</Text>
                        <View
                            style={{
                                flex: 1,
                                height: 1,
